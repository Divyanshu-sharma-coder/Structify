...
int main() {
  ...
  t({ slug: "boolean", name: "Booleans", emoji: "🔘", category: "ds", group: "Primitives", renderer: "primitive",
      ...
      code: `bool b = true;\nif (a && !b) { ... }`,
      explanation: "Logical true/false values stored as 0 or 1 in memory." }),
  t({ slug: "char-string", name: "Characters & Strings", emoji: "🔤", category: "ds", group: "Primitives", renderer: "primitive",
      complexity: { time: "O(n)", space: "O(n)" }, generateSteps: PR.charStringSteps, defaultInput: 'char c = "A";',
      code: `string s = "hello";\nchar c = s[0];`,
      explanation: "Ordered sequences of characters stored as ASCII/Unicode codes." }),
  t({ slug: "pointer", name: "Pointers & References", emoji: "👉", category: "ds", group: "Primitives", renderer: "primitive",
      complexity: { time: "O(1)", space: "O(1)" }, generateSteps: PR.pointerSteps, defaultInput: "int* p = &x;",
      code: `int *p = &x;\n*p = 20;`,
      explanation: "Memory addresses shown as huts with arrows pointing to target variables." }),
